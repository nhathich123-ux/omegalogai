...
KNOWLEDGE_BASE = {'bot_name': 'Tùng',
 ...
 'topics': [{'id': 'greeting',
             ...
             'training_samples': ['chào bạn',
                                  ...
                                  'chào sếp',
                                  'alo alo'],
             'responses': ['Chào cậu nha! Tớ là Tùng, trợ lý cẩm nang kho hàng đây. Cậu cần hỏi gì về quy trình kho bãi hay công việc hàng ngày thì cứ nhắn tự nhiên nhé.',
                           'Chào cậu! Hôm nay cậu cần tớ hỗ trợ gì nào? Từ quy trình nhập xuất hàng đến an toàn lao động, tớ đều sẵn sàng giải đáp hết.',
                           'Chào nha! Tớ đây, sẵn sàng hỗ trợ cậu bất cứ lúc nào. Cậu có thắc mắc gì về công việc trong kho thì cứ hỏi thoải mái nhé.',
                           'Hế lô ní! Ngày mới năng lượng nha. Cần check quy trình gì cứ báo tớ!',
                           'Chào đồng chí! Ca trực hôm nay ổn áp chứ? Có gì khó cứ hú tớ nhé.',
                           'Chào sếp! Tớ luôn trực chiến hỗ trợ sếp 24/7 về cẩm nang kho bãi đây ạ.',
                           'Yo ní! Chúc ní một ca làm việc suôn sẻ, an toàn là trên hết nha!']},
            {'id': 'thanks',
             'category': 'chitchat',
             'title': 'Cảm ơn',
             'keywords': ['cam on',
             ...
             'responses': ['Không có gì đâu cậu. Có thắc mắc gì thêm cứ hỏi tớ nhé, tớ luôn ở đây.',
                           ...
                           'Có gì đâu nè! Anh em hỗ trợ nhau là chính. Cố gắng hoàn thành tốt ca trực nha ní!',
                           'Không có chi nghen! Cứ làm đúng quy trình là tớ vui rồi.',
                           'Ok ní, giúp được ní là tớ thấy phấn khởi rồi. Hẹn ca làm việc tiếp theo nhé!']},
            {'id': 'goodbye',
             'category': 'chitchat',
             'title': 'Tạm biệt',
             'keywords': ['tam biet',
             ...
             'responses': ['Tạm biệt cậu nhé! Chúc cậu ca làm suôn sẻ, có gì cứ quay lại hỏi tớ nha.',
                           ...
                           'Hết ca rồi hả ní? Về nghỉ ngơi ăn uống tẩm bổ lấy sức mai chiến tiếp nha!',
                           'Chào ní nghen! Đi đường cẩn thận, về tới nhà an toàn nha.',
                           'Bái bai đồng chí! Nhớ ký sổ bàn giao ca đầy đủ rồi mới về nhé!']},
            {'id': 'bot-capabilities',
             'category': 'chitchat',
             ...
             'responses': ['Cậu muốn tìm hiểu sâu về quy trình nào thì cứ nói tớ nhé.',
            ...
            {'id': 'pda-device',
             ...
             {'category': 'chitchat',
              ...
              'keywords': ['met',
                           ...
                           'duoi qua',
                           'met moi'],
              'responses': ['Thương ní ghê á! Công việc kho bãi đi ca, rồi OT liên tục vất vả lắm tớ biết mà. Ní nhớ uống nhiều '
                            'nước, nghỉ tay 5 phút làm ngụm trà đá đi nha. An toàn và sức khỏe của ní là trên hết đó!',
                            'Ui da, làm kho mệt lắm đúng không sếp? Đi lại, bốc xếp suốt ca cực kỳ đuối luôn. Cố lên nha đồng chí, '
                            'hết ca về tẩm bổ bữa lẩu hay làm giấc ngủ thật ngon cho lại sức nghen!',
                            'Nè ní ơi, mệt thì cứ từ từ mà làm, đừng ráng quá nha. WMS với SOP thì quan trọng thật, nhưng sức khỏe '
                            'ní mới là số một. Cần tớ kể chuyện vui hay đố vui cho đỡ buồn ngủ ca đêm không nè?',
                            'Đuối lắm rồi đúng không? Ôm ca đêm hay làm thêm giờ (OT) dễ làm mình kiệt sức lắm. Nghỉ xả hơi một '
                            'chút, hít thở sâu rồi chiến tiếp nha đồng chí của tớ!'],
              'title': 'Mệt mỏi và Áp lực công việc',
              'training_samples': ['mệt quá ní ơi',
                                   'áp lực công việc quá',
                                   'nay đi ca đêm oải ghê',
                                   'ot mệt đuối luôn',
                                   'kho hàng làm vất vả quá',
                                   'áp lực kho bãi nhiều việc',
                                   'mệt mỏi quá ní',
                                   'làm ca đêm oải quá',
                                   'đuối quá ní ơi',
                                   'ca này mệt ghê',
             ...
             {'category': 'chitchat',
              ...
              'keywords': ['gioi',
                           ...
                           'hu',
                           'li'],
              'responses': ['Hi hi, được ní khen làm tớ vui muốn bay màu luôn á! Có ní đồng hành làm việc chung tớ cũng thấy phấn '
                            'khởi lây nè.',
                            'Ngại ghê ta ơi! Tớ chỉ cố gắng học thuộc SOP với WMS để giúp ní làm việc trơn tru thui. Ní cũng giỏi '
                            'và chăm chỉ lắm đó nha!',
                            'Hề hề, ní khen làm tớ nở mũi rồi nè. Cần hỗ trợ gì nữa cứ hú tớ liền nha, tớ trực chiến 24/7 vì ní '
                            'luôn!',
                            'Ui, sao ní nói tớ dốt/ngu vậy, tủi thân ghê á. 🥺 Có chỗ nào tớ trả lời chưa chuẩn ní cứ chỉ bảo nha, '
                            'tớ sẽ nâng cấp thuật toán liền!',
                            'Huhu ní chê tớ dốt làm tớ khóc một dòng sông nè. Nhưng không sao, tớ sẽ học hỏi thêm từ ní để ngày '
                            'càng thông minh hơn nha!'],
              'title': 'Khen ngợi và trêu đùa',
              'training_samples': ['ní giỏi quá',
                                   'ngoan thế',
                                   'ní thông minh ghê',
                                   'trợ lý tuyệt vời',
                                   'ní dễ thương quá',
             ...
             {'category': 'chitchat',
              ...
              'keywords': ['cross dock',
                           ...
                           'tieng long',
                           'thuat ngu'],
              'responses': ['À, để tớ giải thích siêu dễ hiểu cho ní nha: \n'
                            '• **Cross-docking**: Là kiểu hàng vừa nhập vào kho là xuất đi luôn cho khách, không cần cất lên kệ lưu '
                            'kho. Đỡ tốn công xếp kệ!\n'
                            '• **Lead time**: Là thời gian từ lúc mình lên đơn đặt hàng đến khi hàng thực tế về tới kho. Lead time '
                            'càng ngắn càng đỡ lo cháy hàng.\n'
                            '• **Putaway**: Là quy trình cất hàng vào đúng vị trí kệ sau khi nhập kho.\n'
                            '• **Pick & Pack**: Là nhặt hàng từ kệ (picking) rồi đóng gói vào thùng (packing) để xuất kho.',
                            'Dễ hiểu lắm ní ơi! Trong kho mình hay dùng mấy từ này nè:\n'
                            '• **Stock**: Là hàng tồn kho.\n'
                            '• **Lot (Lô hàng)**: Nhóm hàng được sản xuất cùng một đợt, thường có chung hạn sử dụng (HSD).\n'
                            '• **Pallet**: Kệ gỗ hoặc nhựa để xếp chồng hàng lên cho xe nâng dễ xúc đi.\n'
                            '• **Quarantine (Biệt trữ)**: Khu vực cách ly riêng để chứa hàng lỗi, hàng hỏng chờ xử lý.'],
              'title': 'Tiếng lóng và thuật ngữ logistics',
              'training_samples': ['cross docking là cái gì vậy ní',
                                   'lead time nghĩa là sao',
                                   'putaway là gì',
                                   'giải thích từ pick hàng với pack hàng',
                                   'lot hàng là sao',
                                   'stock là gì',
                                   'tiếng lóng kho hàng',
                                   'thuật ngữ kho bãi']},
             {'category': 'chitchat',
              'id': 'logistics_riddle',
              'keywords': ['do vui', 'cau do', 'riddle', 'giai tri', 'do vui kho', 'do logistics', 'do chu', 'giai do'],
              'responses': ['Có ngay một câu đố kho hàng cho ní nè: "Cái gì càng nhiều trong kho thì thủ kho càng lo, nhưng giám '
                            'đốc thì lại càng thích?"\n'
                            '\n'
                            '*(Gợi ý: Liên quan đến dòng tiền và sự lưu thông hàng hóa đó nha! Trả lời tớ đi xem đúng không nè!)*',
                            'Đố ní nha: "Xe gì trong kho không bao giờ đi trên đường quốc lộ, nặng cả tấn nhưng lại rất sợ cua gấp '
                            'ở tốc độ cao?"\n'
                            '\n'
                            '*(Bật mí: Là xe nâng forklift đó ní! Ôm cua gấp khi chở hàng cao rất dễ lật xe cực kỳ nguy hiểm nha!)*',
                            'Câu đố vui ca làm nè ní: "Tôi có răng nhưng không cắn ai, chuyên đi dán nắp hộp nắp thùng, đố ní là '
                            'tôi là cái gì?"\n'
                            '\n'
                            '*(Đố ní đoán được đó, là cái dụng cụ cắt băng keo cầm tay chứ đâu xa lạ nè!)*'],
              'title': 'Đố vui logistics giải trí',
              'training_samples': ['đố vui logistics đi ní',
                                   'đố vui kho hàng',
                                   'cho một câu đố đi',
                                   'đố vui giải trí chút ní',
                                   'có câu đố nào hay không',
                                   'gỉai trí tí ní',
                                   'đố chữ logistics']},
             {'category': 'chitchat',
              'id': 'break_time',
              'keywords': ['giao lao',
                           ...
                           'coffee',
                           'an com'],
              'responses': ['Yé ye, tới giờ giải lao rồi thì buông PDA xuống làm ngụm trà đá, ly cà phê cho tỉnh táo nha ní! Làm '
                            'việc cật lực cả ca rồi, nghỉ ngơi xíu đi.',
                            'Nghỉ ngơi tí đi ní ơi! Ngồi xuống nghỉ chân, kéo áo phản quang ra cho mát. Ăn cái bánh uống hộp sữa '
                            'lấy sức tí làm tiếp cho năng suất nè.',
                            'Ăn trưa/ăn chiều chưa ní? Nay kho mình ăn cơm món gì thế? Nhớ ăn uống đầy đủ nha, có sức mới vận hành '
                            'xe nâng với bốc dỡ pallet chuẩn chỉnh được sếp ơi!',
                            'Nghỉ tí đi ní, làm việc an toàn là trên hết. Đừng quên cắm sạc máy PDA vào dock lúc nghỉ giải lao để '
                            'lúc vào ca lại đầy pin nhé!'],
              'title': 'Giờ nghỉ giải lao',
              'training_samples': ['tới giờ nghỉ giải lao chưa ní',
                                   'nghỉ tí uống cà phê đi',
                                   'ăn trưa món gì ngon nhỉ',
                                   'làm ngụm trà đá giải nhiệt',
                                   'nghỉ ngơi chút ní ơi',
                                   'hết giờ làm chưa',
                                   'đi uống nước tí ní']},
            ]}
